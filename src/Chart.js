...
function getSmoothedData(data, smoothing) {
    const smoothedArr = [];
...
export function Chart(props) {
    ...
    let ctx;
    function drawAxis(canvas, axisPadding, position, lineWidth, tickMarks, paddingFactor = CURVE_PADDING_FACTOR) {
    ...
    return _jsxs("div", { className: 'chart', children: [_jsx("h2", { className: 'chartitle', children: props.name }), _jsxs("div", { className: 'canvas-container', children: [props.yAxisLabelPos === 'left' && _jsx("p", { className: 'y-axis-label', children: props.yAxisName }), _jsxs("div", { className: 'canvas-wrapper', children: [_jsx("canvas", { ref: canvasRef, className: props.type }), _jsx("p", { children: props.xAxisName })] }), props.yAxisLabelPos === 'right' && _jsx("p", { className: 'y-axis-label', children: props.yAxisName })] }), props.legendLabels && _jsx(Legend, { labels: props.legendLabels, onClick: props.onLegendClick })] });
}
